package com.drm.up.service;

import com.drm.up.common.CommonUtils;
import com.drm.up.entity.LdapInfo;
import com.drm.up.entity.MachineInfo;
import com.drm.up.repository.MachineInfoRepo;
        ...
        if(machineInfoOpt.isPresent()) {
            ...
            try (ClientSession session = client.connect(machineInfo.getUsername(), machineInfo.getHost(), machineInfo.getPort())
                ...
                if (isConnected) {
                    ...
                    else if(machineInfo.getMachineType().equalsIgnoreCase("linux"))
